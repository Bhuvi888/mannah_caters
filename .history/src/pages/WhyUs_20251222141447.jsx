        ...
        >
          ...
          >
            <img
              src="/whypage.png"
              loading="lazy"
              className="absolute inset-0 w-full h-full object-cover opacity-30 group-hover:scale-105 group-active:scale-105 transition-all duration-700"
            />
            <div className="relative p-8 h-full flex flex-col justify-end bg-gradient-to-t from-black/90 to-transparent">
              <h3 className="font-bold text-center text-[#e2b857] text-lg">
