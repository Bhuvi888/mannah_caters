      ...
      <nav className="bg-green-950 border-b border-green-800 text-yellow-400 sticky top-0 z-50 shadow-2xl backdrop-blur-sm bg-opacity-95 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="text-yellow-400 text-xl font-bold group-hover:scale-125 transition-transform duration-300">
              X
            </span>
            <span className="text-white text-xl font-bold tracking-tight group-hover:text-yellow-400 transition-colors duration-300">
              {companyName}
            </span>
          </div>
          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-4 group p-2 rounded-lg hover:bg-green-900/30 transition-colors duration-300"
                >
      ...
      <footer className="bg-green-950 border-t border-green-800 py-8 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-center gap-2 mb-6 flex-wrap group cursor-default">
            <span className="text-yellow-400 text-xl font-bold group-hover:rotate-180 transition-transform duration-700">
              ✕
            </span>
            <span className="text-white text-xl font-bold group-hover:text-yellow-400 transition-colors duration-300">
              {companyName}
            </span>
          </div>
          ...
          <div className="border-t border-green-800 pt-6">
            <p className="text-center text-yellow-400 hover:text-yellow-200 transition-colors cursor-default">
              © 2023 Mannah Caterers. All rights reserved. Designed with
              elegance.
            </p>
          </div>
        </div>
