      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          >
              ...
              {[
                {
                  ...
                  action:
                    "https://maps.google.com/?q=123 Gourmet Avenue, Culinary District, NY 10012",
            ...
            🧠 Why This Feels Better (Mentor Insight) ✅ No guessing →
            everything clickable behaves like a card ✅ Fitts’s Law → big tap
            area = faster action ✅ Visual feedback → user knows something
            happened ✅ Mobile-first → thumbs love this layout 🔥 Optional Power
            Moves (Next Level) If you want to go harder: 📞 Add Tap to Call
            number 📍 Show mini map preview ✨ Animate icon pulse on hover 🧠
            Auto-detect business open/closed status Tell me the vibe you want —
            luxury, minimal, or bold — and we’ll tune it exactly right.
            {/* Social Icons */}
